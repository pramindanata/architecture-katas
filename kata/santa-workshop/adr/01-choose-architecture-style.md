...
It offers flexibility in how the system will structure, built and performs. Service based allow us selectively choose which features that require high level of availability, elasticity, and performance while the rest of features can be built using monolith architecture.
